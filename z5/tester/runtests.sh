...
declare -a input_data=(
	...
	"1 1 1 1\x0D\x0A"								# OK
	"$max\x0D\x0A"									# OK
	"18446744073709551610 2 3\x0D\x0A"				# OK
    "18446744073709551610 10 20 30\x0D\x0A"			# ERROR
	...
	"000000000000018446744073709551614 1\x0D\x0A"												# OK
	...
	"0000000000000000000000018446744073709551605 000002 00000005 0001\x0D\x0A" 				# OK
...
declare -a expected_data=(
	...
	#"ERROR\x0D\x0AERROR\x0D\x0AERROR\x0D\x0AERROR\x0D\x0A" <- sypie sie przez \0
